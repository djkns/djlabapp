...
export const MIDI_GROUPS = [
  {
    ...
    controls: [
      ...
      { id: "deckA.keylock", label: "Deck A · Keylock",    kind: "button" },
      { id: "deckB.keylock", label: "Deck B · Keylock",    kind: "button" },
      { id: "deckA.loopIn",  label: "Deck A · Loop In",    kind: "button" },
      { id: "deckA.loopOut", label: "Deck A · Loop Out",   kind: "button" },
      { id: "deckB.loopIn",  label: "Deck B · Loop In",    kind: "button" },
      { id: "deckB.loopOut", label: "Deck B · Loop Out",   kind: "button" },
  ...
  },
  {
    ...
    controls: [
      ...
      { id: "hp.enabled",      label: "HP Enable · Toggle",   kind: "button" },
